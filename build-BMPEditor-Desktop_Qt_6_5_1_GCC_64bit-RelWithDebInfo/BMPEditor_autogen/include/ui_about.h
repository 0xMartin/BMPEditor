...
public:
    ...
    void setupUi(QDialog *About)
    {
        ...
        pushButtonGithub->setObjectName("pushButtonGithub");
        QFont font;
    ...
    void retranslateUi(QDialog *About)
    {
        ...
        label_2->setText(QCoreApplication::translate("About", "<html><head/><body><h1 style=\" margin-top:18px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:xx-large; font-weight:700;\">BMP Editor</span></h1><p><span style=\" font-weight:700;\">Author:</span> Martin Kr\304\215ma<br/><span style=\" font-weight:700;\">Last Update:</span> 12. 2. 2024<br/><span style=\" font-weight:700;\">Version:</span> 0.2.0</p></body></html>", nullptr));
