...
struct qt_meta_stringdata_ImageHistogramWidget_t {
    const uint offsetsAndSize[6];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ImageHistogramWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ImageHistogramWidget_t qt_meta_stringdata_ImageHistogramWidget = {
    {
...
QT_MOC_LITERAL(32, 0) // ""
    ...
    "ImageHistogramWidget\0updateDone\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ImageHistogramWidget[] = {
...
const QMetaObject ImageHistogramWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ImageHistogramWidget.offsetsAndSize,
    qt_meta_data_ImageHistogramWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ImageHistogramWidget_t
...
void *ImageHistogramWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageHistogramWidget.stringdata0))
